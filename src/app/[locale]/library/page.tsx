      ...
      <div className="bg-gradient-to-br from-teal-700 to-teal-900 text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            {ALL_TYPES.map((type) => (
              <div key={type} className="bg-cream/10 rounded-xl px-4 py-2 text-center min-w-[90px]">
                ...
                return (
                  <div key={type} className="mb-8">
                    {!activeType && (
                      <div className="flex items-center gap-3 mb-4">
                        <div className="h-px flex-1 bg-gray-200" />
                        <span className="text-xs font-bold text-ink/55 uppercase tracking-wider px-2">
