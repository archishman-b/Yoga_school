  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-[clamp(18px,5vw,56px)] py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed italic" style={{ color: 'rgba(250,247,242,0.4)' }}>
              &ldquo;Yoga for all group, all profession and all religions.&rdquo;
            </p>
            <p className="text-xs mt-1" style={{ color: 'rgba(250,247,242,0.25)' }}>— Rekha Nath, Founder</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { href: `/${locale}/library`, label: 'Practice Library' },
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <div className="space-y-1" style={{ color: 'rgba(250,247,242,0.55)' }}>
                  <a href="tel:03326943100" className="block hover:text-white transition-colors no-underline">(033) 2694 3100</a>
                  <a href="tel:+918017112877" className="block hover:text-white transition-colors no-underline">+91 80171 12877</a>
                  <a href="tel:+919123991667" className="block hover:text-white transition-colors no-underline">+91 91239 91667</a>
                </div>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <div>
                  <p style={{ color: 'rgba(250,247,242,0.75)' }} className="font-medium">Monday – Friday</p>
                  <p className="text-xs mt-0.5" style={{ color: 'rgba(250,247,242,0.4)' }}>6:00 AM – 9:00 PM</p>
                </div>
              </li>
        ...
        >
          © {year} Nibedita Yoga Training Centre. All rights reserved.
        </div>
      </div>
    </footer>
  );
